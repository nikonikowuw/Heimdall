#!/usr/bin/env python3
"""
Convert YOLOv8-face and EdgeFace weights to Apple CoreML .mlpackage format.

The yolo26n body detector is synchronized from the general_detection package by
`make models-sync`; this script intentionally does not generate the legacy
person detector variants.
...
def main():
    ...
    print("\n Face models converted and verified successfully!")
